    ...
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-r from-blue-500 to-purple-600 text-white">
      <div className="bg-white p-8 rounded-lg shadow-lg max-w-md w-full text-gray-900">
        <div className="text-center mb-6">
          <img src="https://example.com/smarthome-logo.png" alt="SmartHome Logo" className="w-24 h-24 mx-auto mb-4" />
          <h1 className="text-4xl font-bold mb-2">SmartHome</h1>
          <h2 className="text-2xl font-semibold mb-6">Shop Now in the Future</h2>
        </div>
