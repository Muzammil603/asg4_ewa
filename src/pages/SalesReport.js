...
function SalesReport() {
  ...
  const fetchSalesData = async () => {
    try {
      const response = await fetch('http://127.0.0.1:5001/api/sales'); // Replace with actual API
  ...
  const fetchDailySalesData = async () => {
    try {
      const response = await fetch('http://127.0.0.1:5001/api/daily-sales'); // Replace with actual API
      const data = await response.json();
      setDailySales(data);
    } catch (error) {
